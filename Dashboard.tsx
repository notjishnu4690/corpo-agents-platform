...
import { GlitchText, GlitchButton, AgentMoodIndicator } from "@/components/CyberComponents";
...
export default function Dashboard() {
  ...
  const [agentMoods] = useState<Record<string, "optimal" | "stressed" | "idle" | "processing">>({
    ceo: "optimal",
    finance: "processing",
    hr: "idle",
    reporter: "optimal",
  ...
  }, [chatMessages, selectedAgent, chatMode, chatSearch]);
        ...
        <div className="flex-1 overflow-hidden relative">
          <AnimatePresence mode="wait">
            {activeTab === "messages" && (
              ...
              >
                {/* Chat Mode Toggle & Search */}
                <div className={`px-8 py-4 border-b flex flex-wrap gap-4 items-center justify-between ${borderColor}`}>
                  ...
                  <div className="relative flex-1 max-w-xs">
                    <input
                      ...
                      className={`w-full px-4 py-2 rounded-lg text-xs font-mono focus:outline-none focus:ring-1 focus:ring-cyan-400 transition-all ${
                            ...
                            >
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex items-center justify-between">
                                  ...
                                  <AgentMoodIndicator mood={agentMoods[agent.id]} />
                                </div>
                ...
                <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2 space-y-8">
                    <div className={`${cardBg} rounded-3xl p-8 border ${borderColor}`}>
                      <h2 className="text-lg font-black uppercase mb-6 text-cyan-400">Agent Performance Matrix</h2>
                      <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={[
                            { name: "CEO", perf: 92 },
                            { name: "Finance", perf: 88 },
                            { name: "HR", perf: 95 },
                            { name: "Ops", perf: 84 },
                          ]}>
                            <CartesianGrid strokeDasharray="3 3" stroke={theme === "dark" ? "#ffffff10" : "#00000010"} />
                            <XAxis dataKey="name" stroke={theme === "dark" ? "#64748b" : "#475569"} />
                            ...
                            <Bar dataKey="perf" fill="#00f0ff" radius={[8, 8, 0, 0]} />
                          </BarChart>
                        </ResponsiveContainer>
                      </div>
                    </div>
