              ...
              <div className="bg-black/40 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
                ...
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-cyan-400 text-black font-bold rounded-2xl hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Next: Select Agents →
                  </button>
                </div>
              ...
              <div className="bg-black/40 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 py-4 bg-cyan-400 text-black font-bold rounded-2xl hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
